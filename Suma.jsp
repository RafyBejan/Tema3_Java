...
<body>
	...
	<p>Suma celor două numere:</strong> <%=suma%></p>
	  <p> Verificare paritate:</strong> <%=rezultatParitate%></p>
	<p>Număr de vocale:</strong> String-ul "<%=inputString%>" conține <%=nrVocale%> vocale.
	</p>
